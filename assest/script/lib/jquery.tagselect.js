      ...
      this.tagselect = {
        ...
        createHd: function(els) {
            ...
            if ($(el).is('optgroup')) {
              $(el).children().each(function(index, subel) {
                ...
                if ($(subel).attr('selected')) {
                  selectOpt.push('<li class="qtagselect__choice ' + _class + '" data-cid="' + id + '"><span>' + $(subel).text() + '</span><a class="qtagselect__del"><i class="fa fa-close"></i></a></li>');
                }
              })
            } else {
              if ($(el).attr('selected')) {
                selectOpt.push('<li class="qtagselect__choice ' + _class + '" data-cid="' + id + '"><span>' + $(el).text() + '</span><a class="qtagselect__del"><i class="fa fa-close"></i></a></li>');
              }
            }
          })
          ...
          if (_this.E.find('[selected]').length > 0) {
            ...
            field = '<li class="qtagselect__field"><span class="qtagselect__placeholder ss">' + settings.placeholder + '</span><span class="qtagselect__btn"></span></li>';
          }
        ...
        createDropFooter: function() {
          ...
          if (settings.dropFooter) {
            dropFooter = '<div class="qtagselect__drop__ft"><a href="javascript:void(0); .text-Small-light" class="qtagselect__closelink">اغلاغ<span class="qtagselect__triangle"></span></a></div>';
          }
          return dropFooter;
        },
        showDrop: function(e) {
        ...
        showOpt: function(e) {
          ...
          if (ul.find('.qtagselect__choice').length < settings.maxTag) {
            ...
            ul.append('<li class="qtagselect__choice ' + _class + '" data-cid="' + _this.attr("data-rid") + '"><span>' + _this.html() + '</span><a class="qtagselect__del"><i class="fa fa-close"></i></a></li>');
        ...
        removeOpt: function(e) {
          ...
          if (!ul.find('.qtagselect__choice').length > 0) {
            ul.find('.qtagselect__field').prepend('<span class="qtagselect__placeholder text-Small-light">اضغط لاضافة عنصر</span>');
          }
          e.stopPropagation();
        }
      };
