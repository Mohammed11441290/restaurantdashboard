...
function MultiSelectTag(el, customs = { shadow: false, rounded: true }) {
    ...
    function createElements() {
        ...
        const icon = domParser.parseFromString(
            `<i class="fa fa-arrow-down"></i>`, 'image/svg+xml').documentElement;
    ...
    function createTag(option) {
        ...
        itemLabel.classList.add('item-label','text-Small-lighter');
       
        itemLabel.innerHTML = option.label;
        itemLabel.dataset.value = option.value;
        const itemClose = domParser.parseFromString(
            `<i class="fa fa-xmark-circle"></i>`, 'image/svg+xml').documentElement;
